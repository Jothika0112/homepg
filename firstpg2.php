...
<body>
        ...
        <div class="navbar">
            ...
            <nav>
                <ul id='MenuItems'>
                    ...
                    <li><a href='http://localhost/homepg/firstpg.php'><button class='loginbtn'>Student Login</button></a></li>
					<li><button class='loginbtn' onclick="document.getElementById('login-form1').style.display='block'" style="width:auto;">Faculty Login</button></li>
                 </ul>
            </nav>
        </div>
        <div id='login-form1'class='login-page'>
	...
	<div class="form-box">
		...
		<form method="post" action="server.php" id='login' class='input-group-login'>
			<input type='text' name='email' class='input-field' autocomplete="off" placeholder='Email Id' required >
	<input type='password' name='pass' class='input-field' autocomplete="off" placeholder='Enter Password' required><br><br><br><br><br>
	
	
	<button type='submit'class='submit-btn' name="login__user">Log in</button>
	
	
 </form>
 <form method="post" action="server.php" id='register' class='input-group-register'>
 <input type='text'class='input-field' name='id' autocomplete="off" placeholder='Faculty Id' required>
	 ...
	 <input type='password'class='input-field' name='password_2' autocomplete="off" placeholder='Confirm Password'  required><br>
	 
			<button type='submit'class='submit-btn' name='reg__user'>Register</button>
	 </form>
	</div>
</div>
    </div>
