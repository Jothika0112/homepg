...
<head>
  ...
  <link rel="stylesheet" href="assets/css/bootstraap.css"/>
  <link rel="stylesheet" href="assets/css/lecturehalldata.css"/>
</head>
<body>
  <a href="selectoneof3.php" class="btn  btn-sm"><span class="glyphicon glyphicon-chevron-left"></span>back</a>
  <?php
  
  mysqli_query($db,"UPDATE viewcount set views=views+1 where pagename='lecturehalldata'");
  $re=mysqli_query($db,"SELECT * from viewcount where pagename='lecturehalldata' ");
  ...
  <div class="panel panel-default">
    ...
    <tr>
      ...
      <table class="table table-hover" border="3">
        ...
        $retvalsub1=mysqli_query($db,$subq1);
    ...
    <tr>
      ...
      <table class="table table-hover" border="4">
        ...
        $retvalsub2=mysqli_query($db,$subq2);
