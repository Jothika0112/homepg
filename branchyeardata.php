...
<head>
  ...
  <link rel="stylesheet" href="assets/css/branchyeardata.css"/>
...
mysqli_query($db,"UPDATE viewcount set views=views+1 where pagename='branchwisedata'");
$re=mysqli_query($db,"SELECT * from viewcount where pagename='branchwisedata' ");
  ...
  <div class="row">
    <div class="col-xs-10 col-xs-push-1" >
      <div class="panel panel-default" >
        ...
        $retvalsquery=mysqli_query($db,$subquery);
        ?>
        <?php
        while ($rowclassdata=mysqli_fetch_assoc($retvalsquery)) {
          ...
          $retvalclassquery=mysqli_query($db,$classquery);//class query retrival
         ...
         $retvalroll=mysqli_query($db,$rollnoquery);
